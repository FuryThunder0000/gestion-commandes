            ...
            <div class="card w-100">
                  <div class="card-body p-4">
                        <div class="row">
                              ...
                              <div class="col">
                                    <a href="{{route('clients.create')}}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Nouveau</a>
                              </div>
                        </div>
                                          ...
                                          <tr class="border-top">
                                                ...
                                                <td class="border-bottom-0">
                                                      <div class="d-flex align-items-center gap-2">
                                                            <a href="{{route('clients.show', $client->id)}}" class="badge border text-dark rounded-3 fw-semibold">
                                                                  <span>
                                                                        Show
                                                                  </span>
                                                            </a>
                                                            <a href="{{route('clients.edit', $client->id)}}" class="badge border text-dark rounded-3 fw-semibold">
                                                                  <span>
                                                                        Edit
                                                                  </span>
                                                            </a>
